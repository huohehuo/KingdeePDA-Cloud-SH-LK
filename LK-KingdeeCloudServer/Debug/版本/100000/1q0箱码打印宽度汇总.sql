...
set @FPackets = dbo.getString(@mainStr,'|',2) --包数 
...
set @FWidth =dbo.getString(@mainStr,'|',9) --宽度
set @FBatchNo =dbo.getString(@mainStr,'|',10) --批次 第一次传空 如果有第二次就取第一次得到的批次
