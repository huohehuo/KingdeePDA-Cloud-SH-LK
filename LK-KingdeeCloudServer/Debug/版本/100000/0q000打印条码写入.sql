if (exists (select * from sys.objects where name = 'proc_PDABarCodeSign2_Insert2'))
    drop proc proc_PDABarCodeSign2_Insert2
go
create proc proc_PDABarCodeSign2_Insert2
(
