if (exists (select * from sys.objects where name = 'proc_K3AllotPushAllotIn'))
drop proc proc_K3AllotPushAllotIn
go
create proc proc_K3AllotPushAllotIn
(
...
select @FInterID,b.FBarCode,a.FQty,@FBillNo,'调拨申请单下推分布式调入单',b.FStockID,b.FStockPlaceID,a.FStockID,a.FStockPlaceID from a_DetailsTable a left join t_PDABarCodeSign b on a.FBarCode=b.FBarCode where FOrderID=@FOrderID and FPDAID=@FPDAID
