if (exists (select * from sys.objects where name = 'proc_K3AllotPushAllotDirect'))
drop proc proc_K3AllotPushAllotDirect
go
create proc proc_K3AllotPushAllotDirect
(
...
select @FInterID,b.FBarCode,a.FQty,@FBillNo,'调拨申请单下推直接调拨单',b.FStockID,b.FStockPlaceID,a.FStockID,a.FStockPlaceID from a_DetailsTable a left join t_PDABarCodeSign b on a.FBarCode=b.FBarCode where FOrderID=@FOrderID and FPDAID=@FPDAID
