if (exists (select * from sys.objects where name = 'proc_K3AssembleAndBarCode1_Allot'))
drop proc proc_K3AssembleAndBarCode1_Allot
go
create proc proc_K3AssembleAndBarCode1_Allot
(
...
select @FInterID,b.FBarCode,a.FQty,@FBillNo,'直接调拨单',b.FStockID,b.FStockPlaceID,a.FStockID,a.FStockPlaceID from a_DetailsTable a left join t_PDABarCodeSign b on a.FBarCode=b.FBarCode where FOrderID=@FOrderID and FPDAID=@FPDAID
