...
begin tran declare
  ...
  update t_AssembleRecord1  set FInterIDOut=@FInterID, FStatus = 2,FRemark = '生产领料单' from (select a.* from t_AssembleRecord1Temp a left join t_AssembleRecord1 b on a.FBillNo=b.FBillNo where a.FOrderID=@FOrderID and a.FPDAID=@FPDAID) as t where t_AssembleRecord1.FBillNo=t.FBillNo
