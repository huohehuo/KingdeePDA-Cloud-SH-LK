if (exists (select * from sys.objects where name = 'proc_K3STKCOUNTLOSS'))
drop proc proc_K3STKCOUNTLOSS
go
create proc proc_K3STKCOUNTLOSS
(
...
begin tran declare
          ...
          select @FInterID=FID from T_STK_STKCOUNTLOSS where FBillNo=@FBillNo 
