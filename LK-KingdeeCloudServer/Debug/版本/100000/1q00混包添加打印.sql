if (exists (select * from sys.objects where name = 'proc_PDAAssembleAdd_Insert1'))
    drop proc proc_PDAAssembleAdd_Insert1
go
create proc proc_PDAAssembleAdd_Insert1
(
...
values (@FBillNo,@FIndex,@FDate,@FBillerID,0,@FShortDate,@FCarNum,@FHuZhu,'123',0,2)
