...
/**
 * 根据PDA 的 IMIE码删掉所有条码唯一临时表的数据
 */
@WebServlet(urlPatterns = "/DeleteBoxCodeAll")
public class DeleteBoxCodeAll extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(json!=null&&!json.equals("")){
            try {
                ...
                SQL = "delete from t_AssembleRecord1Temp where 1=1 "+con;
