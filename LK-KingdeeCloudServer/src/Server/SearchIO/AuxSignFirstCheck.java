 ...
 */
@WebServlet(urlPatterns = "/AuxSignFirstCheck")
public class AuxSignFirstCheck extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (parameter != null) {
            try {
                ...
                SQL="select FISENABLE,FVALUESET from T_BD_MATERIALAUXPTY where FMATERIALID = '"+parameter+"' and FAUXPROPERTYID= 100002";
                sta = conn.prepareStatement(SQL);
                System.out.println("AuxSignFirstCheck-SQL:"+SQL);
                rs = sta.executeQuery();
