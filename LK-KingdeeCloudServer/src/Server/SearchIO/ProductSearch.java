        ...
        if (parameter != null) {
            try {
                ...
                if (SearchBean.product_for_barcode.equals(searchBean.searchType)){
                    ...
                    con=con+" and t0.F_ORA_TEXT= '"+s2Product.likeOr+"'";
                ...
                if(rs!=null){
                    ...
                    while (rs.next()) {
                        ...
                        productBean.FProduceUnitNumber                = rs.getString("生产单位编码");
                        productBean.FPurchaseUnitID               = rs.getString("采购单位ID");
                        productBean.FPurchaseUnitNumber               = rs.getString("采购单位编码");
                        productBean.FPurchasePriceUnitID          = rs.getString("采购计价单位ID");
                        productBean.FPurchasePriceUnitNumber          = rs.getString("采购计价单位编码");
                        productBean.FSaleUnitID                   = rs.getString("销售单位ID");
                        productBean.FSaleUnitNumber                   = rs.getString("销售单位编码");
                        productBean.FSalePriceUnitID              = rs.getString("销售计价单位ID");
                        productBean.FSalePriceUnitNumber              = rs.getString("销售计价单位编码");
                        productBean.FStoreUnitID                  = rs.getString("库存单位ID");
                        productBean.FStoreUnitNumber                  = rs.getString("库存单位编码");
                        productBean.FAuxUnitID                    = rs.getString("辅助单位ID");
                        productBean.FAuxUnitNumber                    = rs.getString("辅助单位编码");
                        productBean.FBaseUnitID                   = rs.getString("基本单位ID");
                        productBean.FBaseUnitNumber                   = rs.getString("基本单位编码");
