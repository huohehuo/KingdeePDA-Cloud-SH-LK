 ...
 * 条码打印
 */
@WebServlet(urlPatterns = "/GetBoxPrintData")
public class GetBoxPrintData extends HttpServlet {
...
//                        cBean. FVolSplit					=rs.getString("面积");
                        ...
                        cBean.FFBaoNum					=rs.getString("分包数");
