 ...
 * 条码打印
 */
@WebServlet(urlPatterns = "/PrintOutCheck4BoxCode")
public class PrintOutCheck4BoxCode extends HttpServlet {
...
//                        "left join  T_BD_UNITCONVERTRATE t_R3 on (t_R3.FMASTERID=t1.FItemID and t_R3.FCURRENTUNITID = t2U.FSTOREUNITID)where 1=1 "+con +" ORDER BY t1.FBarCode ASC";
                ...
                if(rs!=null){
                    ...
                    Lg.e("PrintOutCheck4BoxCode:"+list.size(),list);
