 ...
 * 条码打印
 */
@WebServlet(urlPatterns = "/GetSplitBoxData")
public class GetSplitBoxData extends HttpServlet {
...
//                }else{//通过批号查找
//                    con=con+"and t1.FBillNo like '%"+searchBean.json+"%'" ;
//                }
...
//                        "left join  T_BD_UNITCONVERTRATE t_R3 on (t_R3.FMASTERID=t1.FItemID and t_R3.FCURRENTUNITID = t2U.FSTOREUNITID)where 1=1 "+con +" ORDER BY t1.FBarCode ASC";
                ...
                if(rs!=null){
                    ...
                    while (rs.next()) {
                        ...
                        cBean.FID					=rs.getString("FID");
                        cBean.FEntryID					=rs.getString("FEntryID");
                        cBean.FItemID					=rs.getString("FItemID");
                        cBean.FUnitID					=rs.getString("FUnitID");
                        cBean.FDCStockID				=rs.getString("FDCStockID");
                        cBean.FDCSPID					=rs.getString("FDCSPID");
                        cBean.FSTOCKORGID				=rs.getString("FSTOCKORGID");
                        cBean.FOWNERID					=rs.getString("FOWNERID");
                        cBean.FChang					=rs.getString("总长");
                        cBean.FKuan					=rs.getString("宽");
                        cBean.FHou					=rs.getString("厚");
...
//                        }
                    ...
                    Lg.e("GetSplitBoxData:"+list.size(),list);
