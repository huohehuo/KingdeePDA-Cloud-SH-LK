 ...
 * 条码检测（出库）
 */
@WebServlet("/PrintData4FlInStore")
public class PrintData4FlInStore extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintData4FlInStore() {
        super();
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++) {
					sta = conn.prepareStatement("exec proc_PDAAssemblePOOrder_Insert1 ?,?,?,?,?,?");
