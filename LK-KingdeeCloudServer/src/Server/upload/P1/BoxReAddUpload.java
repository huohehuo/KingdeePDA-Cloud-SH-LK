 ...
 */
@WebServlet("/BoxReAddUpload")
public class BoxReAddUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoxReAddUpload() {
        super();
    }
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				System.out.println(request.getParameter("sqlip")+" "+request.getParameter("sqlport")+" "+request.getParameter("sqlname")+" "+request.getParameter("sqlpass")+" "+request.getParameter("sqluser"));
					sta = conn.prepareStatement("exec proc_K3ProductIn1_Assemble ?");
					sta.setString(1, parameter);
					execute = sta.execute();
					Lg.e("BoxReAddUpload："+execute);
