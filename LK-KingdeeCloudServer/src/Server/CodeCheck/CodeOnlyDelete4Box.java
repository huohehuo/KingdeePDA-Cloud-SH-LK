 ...
 */
@WebServlet("/CodeOnlyDelete4Box")
public class CodeOnlyDelete4Box extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeOnlyDelete4Box() {
        super();
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_AssembleOut1_delete ?,?,?,?,?");
