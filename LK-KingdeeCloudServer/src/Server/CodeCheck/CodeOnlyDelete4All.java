 ...
 */
@WebServlet("/CodeOnlyDelete4All")
public class CodeOnlyDelete4All extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeOnlyDelete4All() {
        super();
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_DeleteBarCodeAssemble1 ?,?,?,?,?");
