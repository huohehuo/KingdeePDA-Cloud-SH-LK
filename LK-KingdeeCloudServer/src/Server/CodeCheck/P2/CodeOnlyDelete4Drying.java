 ...
 */
@WebServlet("/CodeOnlyDelete4Drying")
public class CodeOnlyDelete4Drying extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeOnlyDelete4Drying() {
        super();
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_AssembleOut_delete ?,?,?,?,?");
