...
/** 
 * DAO for table "STORE_MAN".
*/
public class StoreManDao extends AbstractDao<StoreMan, Void> {

    public static final String TABLENAME = "STORE_MAN";

    /**
     * Properties of entity StoreMan.<br/>
    ...
    public StoreManDao(DaoConfig config) {
        super(config);
    }
    
    public StoreManDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STORE_MAN\" (" + //
                "\"FID\" TEXT," + // 0: FID
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"STORE_MAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, StoreMan entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, StoreMan entity) {
        stmt.clearBindings();
    ...
    @Override
    public StoreMan readEntity(Cursor cursor, int offset) {
        StoreMan entity = new StoreMan( //
    ...
    @Override
    public void readEntity(Cursor cursor, StoreMan entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(StoreMan entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(StoreMan entity) {
        return null;
    }

    @Override
    public boolean hasKey(StoreMan entity) {
        // TODO
        return false;
    }
