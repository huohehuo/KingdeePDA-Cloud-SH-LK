...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private void writeToSDcard(Throwable ex) throws IOException, PackageManager.NameNotFoundException {
        ...
        com.fangzuo.assist.cloud.Utils.Asynchttp.post(mContext, Config.Error_Url, Config.Company+"^"+"Crash"+"^"+builder.toString(), new com.fangzuo.assist.cloud.Utils.Asynchttp.Response() {
                            @Override
                            public void onSucceed(com.fangzuo.assist.cloud.Beans.CommonResponse cBean, com.loopj.android.http.AsyncHttpClient client) {
