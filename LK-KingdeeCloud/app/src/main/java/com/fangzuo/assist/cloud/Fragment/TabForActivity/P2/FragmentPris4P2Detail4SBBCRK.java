...
public class FragmentPris4P2Detail4SBBCRK extends BaseFragment {
...
//                btnBackorder.setClickable(true);
                    ...
                    delete.setNegativeButton("反馈信息", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DataService.pushBackJson(mContext, FragmentPris4P2Detail4SBBCRK.this.getClass().getSimpleName(), Hawk.get(Config.Company,""));
                        }
                    });
                    delete.create().show();
                }
...
//                            activityPager.finish();
    ...
    public FragmentPris4P2Detail4SBBCRK() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // 与fragment_pris_p2_detail区别是长度和厚度可以输入小数点1127
        View view = inflater.inflate(R.layout.fragment_pris_p2_detail_4_sbbcrk, container, false);
