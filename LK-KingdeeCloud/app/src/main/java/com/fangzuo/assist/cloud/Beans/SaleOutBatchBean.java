...
public class SaleOutBatchBean {
    ...
    private List<SaleOutBean.ModelBean> Model;
    ...
    public List<SaleOutBean.ModelBean> getModel() {
        return Model;
    }

    public void setModel(List<SaleOutBean.ModelBean> Model) {
        this.Model = Model;
    }
