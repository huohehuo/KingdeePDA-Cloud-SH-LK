...
public class SuppliersRyAdapter extends RecyclerArrayAdapter<Suppliers> {
    public SuppliersRyAdapter(Context context) {
        super(context);
    }
    //
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<Suppliers> {
...
//            date =      $(R.id.tv_date);
        ...
        @Override
        public void setData(Suppliers data) {
            super.setData(data);
