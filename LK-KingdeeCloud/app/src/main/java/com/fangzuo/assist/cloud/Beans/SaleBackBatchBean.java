...
public class SaleBackBatchBean {
    ...
    private List<SaleBackBean.ModelBean> Model;
    ...
    public List<SaleBackBean.ModelBean> getModel() {
        return Model;
    }

    public void setModel(List<SaleBackBean.ModelBean> Model) {
        this.Model = Model;
    }
