...
public class PushDownSubP2ListAdapter extends BaseAdapter {
    Context context;
    List<PushDownSub> items;
    private int changeColor=-1;
    public PushDownSubP2ListAdapter(Context context, List<PushDownSub> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.pushdown_sub_p2_list, null);
...
//        viewHolder.tvLv.setText("等级:" + items.get(i).FLevel);
        viewHolder.tvLenght.setText("长度:" + items.get(i).FYmLenght+"    ft");
        viewHolder.tvDia.setText("直径:" + items.get(i).FYmDiameter+"    in");
