...
public class ReViewP24DryingAdapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    ...
    public ReViewP24DryingAdapter(Context context, List<DryingGetData> detail, List<Boolean> isCheck) {
