...
public class ReViewCheckP233Adapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    ...
    public ReViewCheckP233Adapter(Context context, List<TempDetil> detail, List<Boolean> isCheck) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_review_pd_p2_33_check_list, null);
