...
public class ReViewP24SplitAdapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    List<WortPrintData> detail;
    private ViewHolder viewHolder;
    InnerClickListener mListener;
    List<Boolean> isCheck;

    public ReViewP24SplitAdapter(Context context, List<WortPrintData> detail, List<Boolean> isCheck) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_review_list_p2_4split, null);
        ...
        viewHolder.tvSum.setText("PCS:" + detail.get(i).FQtySplit);
        viewHolder.tvM2.setText("M2:" + detail.get(i).FM2Split);
        viewHolder.tvLenght.setText("总长:" + detail.get(i).FChang+"  MM");
        viewHolder.tvThick.setText("厚:" + detail.get(i).FHou+"  MM");
        viewHolder.tvWide.setText("宽:" + detail.get(i).FKuan+"  MM");
