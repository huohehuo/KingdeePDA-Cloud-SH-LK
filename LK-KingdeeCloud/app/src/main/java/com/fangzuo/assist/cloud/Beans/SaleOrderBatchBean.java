...
public class SaleOrderBatchBean {
    ...
    private List<SaleOrderBean.ModelBean> Model;
    ...
    public List<SaleOrderBean.ModelBean> getModel() {
        return Model;
    }

    public void setModel(List<SaleOrderBean.ModelBean> Model) {
        this.Model = Model;
    }
