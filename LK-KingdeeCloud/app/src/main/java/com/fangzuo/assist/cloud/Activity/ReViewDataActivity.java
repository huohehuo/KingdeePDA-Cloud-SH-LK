...
import com.fangzuo.assist.cloud.Adapter.ReViewDataAdapter;
...
import com.fangzuo.assist.cloud.databinding.ActivityReViewDataBinding;
...
public class ReViewDataActivity extends BaseActivity {
    ActivityReViewDataBinding binding;
...
//                break;
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_re_view_data);
    ...
    private void initList() {
        ...
        adapter = new ReViewDataAdapter(mContext, list, isCheck);
...
//            binding.productnum.setText("基本数量:" + num +list.get(0).FBaseUnit);
            binding.tvStorenum.setText("数量:" + DoubleUtil.Cut4(storenum+"") + list.get(0).FUnit);
        } else {
