...
public class ProductISBatchBean {
    ...
    private List<ProductISBean.ModelBean> Model;
    ...
    public List<ProductISBean.ModelBean> getModel() {
        return Model;
    }

    public void setModel(List<ProductISBean.ModelBean> Model) {
        this.Model = Model;
    }
