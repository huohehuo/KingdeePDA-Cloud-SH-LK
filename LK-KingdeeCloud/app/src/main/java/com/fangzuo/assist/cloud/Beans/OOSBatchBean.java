...
public class OOSBatchBean {
    ...
    private List<OtherOutBean.ModelBean> Model;
    ...
    public List<OtherOutBean.ModelBean> getModel() {
        return Model;
    }

    public void setModel(List<OtherOutBean.ModelBean> Model) {
        this.Model = Model;
    }
