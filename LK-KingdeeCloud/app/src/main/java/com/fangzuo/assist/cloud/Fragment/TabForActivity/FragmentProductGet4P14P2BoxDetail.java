...
public class FragmentProductGet4P14P2BoxDetail extends BaseFragment {
            ...
            case EventBusInfoCode.Upload_OK://回单成功
                ...
                if (backData.getResult().getResponseStatus().getIsSuccess()) {
                    ...
                    for (int i = 0; i < mains.size(); i++) {
                        ...
                        App.getRService().doIOAction(WebApi.PGet4BOxUpload, reString, new MySubscribe<CommonResponse>() {
                            @Override
...
//                btnBackorder.setClickable(true);
                    LoadingUtil.dismiss();
                    DataModel.submitAndAudit(mContext, Config.ProductGet4BoxActivity, listOrder.get(0));
                } else {
                    LoadingUtil.dismiss();
                    ...
                    delete.setNegativeButton("反馈信息", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DataService.pushBackJson(mContext, FragmentProductGet4P14P2BoxDetail.this.getClass().getSimpleName(), Hawk.get(Config.Company,""));
                        }
                    });
                    delete.create().show();
                }
...
//                    }
                        ...
                        edBaoNum.setText(LocDataUtil.getBaoNum(ordercode,activity,wortPrintDataList.get(0).FFBaoNum));
...
//                        scanNum = wortPrintDataList.FQty;
                        ...
                        tvGoodName.setText(wortPrintDataList.get(0).FName);
...
//                        autoStorage = wortPrintDataList.FStockID;
                        ...
                        DataModel.getProductForId4P2(wortPrintDataList.get(0).FItemID);//03/12:已改为FNumber查找，不分org
                    } else {
...
//                Lg.e("回单数据：", JsonDealUtils.JSonP2DryingGet(mains,listMap));
                DataModel.upload(Config.C_BatcnSave,Info.getJson(activity,JsonDealUtils.JSonP1PrGet4Box(mains,listMap)));
                break;

        }
    }

    public FragmentProductGet4P14P2BoxDetail() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_product_get4box_detail_p1, container, false);
