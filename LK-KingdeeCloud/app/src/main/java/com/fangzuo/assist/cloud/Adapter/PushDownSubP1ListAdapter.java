...
public class PushDownSubP1ListAdapter extends BaseAdapter {
    Context context;
    List<PushDownSub> items;
    private int changeColor=-1;
    public PushDownSubP1ListAdapter(Context context, List<PushDownSub> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.pushdown_sub_p1_list, null);
