...
import com.fangzuo.assist.cloud.databinding.ActivityReViewPdap2ctivityBinding;
...
public class ReViewPDAP2ctivity extends BaseActivity {
    ActivityReViewPdap2ctivityBinding binding;
    private int activity;
    private String  fid;
    //    private T_main main;
    private List<T_Detail> list;
    private List<T_main> list_main;
    private ReViewPDAP2Adapter adapter;
...
//                    e.printStackTrace();
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_re_view_pdap2ctivity);
...
//            zpSDK = App.getInstance().getZpk();
    ...
    private void initList() {
        ...
        Lg.e("列表数据：" ,list);
        adapter = new ReViewPDAP2Adapter(mContext, list, isCheck);
