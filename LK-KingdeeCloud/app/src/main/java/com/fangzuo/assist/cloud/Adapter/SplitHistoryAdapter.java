...
public class SplitHistoryAdapter extends RecyclerArrayAdapter<PrintErrorHistory> {
    public SplitHistoryAdapter(Context context) {
        super(context);
    }
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<PrintErrorHistory> {
        ...
        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_split_history_list);
        ...
        @Override
        public void setData(PrintErrorHistory data) {
            super.setData(data);
            tv_model1.setText(data.FTime);
            tv_model2.setText(data.FBoxCode);
            if ("0".equals(data.FState)){
                tv_model3.setText("打印失败");
            }else{
                tv_model3.setText("打印成功");
            }
        }
    }
