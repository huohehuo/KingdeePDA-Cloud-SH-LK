...
public class PushDownSubList42Adapter extends BaseAdapter {
    Context context;
    List<PushDownSub> items;

    public PushDownSubList42Adapter(Context context, List<PushDownSub> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.pushdown_sublist42, null);
...
//        }
        ...
        viewHolder.tvDate.setText(items.get(i).FCreateDate);
        viewHolder.tvAuxNum.setText("添加辅助数量:"+ items.get(i).FAuxQtying);
        viewHolder.tvOAuxNum.setText("订单辅助数量:"+ items.get(i).FAuxQty);
