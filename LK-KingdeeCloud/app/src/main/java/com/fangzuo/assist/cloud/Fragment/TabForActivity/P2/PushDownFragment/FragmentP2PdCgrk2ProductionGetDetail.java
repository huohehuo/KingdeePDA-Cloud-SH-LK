...
public class FragmentP2PdCgrk2ProductionGetDetail extends BaseFragment {
...
//                btnBackorder.setClickable(true);
                    DataModel.submitAndAudit(mContext, Config.P2PdCgrk2ProductGetActivity, listOrder, tag);
                } else {
                    LoadingUtil.dismiss();
                    ...
                    delete.setNegativeButton("反馈信息", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DataService.pushBackJson(mContext, FragmentP2PdCgrk2ProductionGetDetail.this.getClass().getSimpleName(), Hawk.get(Config.Company,""));
                        }
                    });
                    delete.create().show();
                }
...
//                }
    ...
    public FragmentP2PdCgrk2ProductionGetDetail() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_p2_pd_cgrk2prget_detail, container, false);
...
//            Toast.showText(mContext, "表头数据获取失败");
        ...
        ordercode = CommonUtil.createOrderCode(activityPager.getActivity() + pushDownMain.FID);//单据编号
...
//        DataModel.codeCheck(WebApi.CodeCheckForOut, gson.toJson(bean));
    ...
    protected void initListener() {
        btnBackorder.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
...
//            }
            ...
            t_detailDao.deleteInTx(t_detailDao.queryBuilder().where(
                    T_DetailDao.Properties.FOrderId.eq(ordercode)).build().list());
...
//            detail.FProductNo = edPurchaseNo.getText().toString();
                        detail.FBatch = pushDownSub.FBatchNo;
