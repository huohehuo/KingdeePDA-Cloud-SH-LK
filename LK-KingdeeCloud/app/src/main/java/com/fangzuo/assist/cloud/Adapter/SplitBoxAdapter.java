...
public class SplitBoxAdapter extends RecyclerArrayAdapter<WortPrintData> {
    public SplitBoxAdapter(Context context) {
        super(context);
    }
...
//    }
    ...
    public String getAllM2(){
        Double num=0.0;
        for (int i = 0; i < getAllData().size(); i++) {
            num=MathUtil.sum(num+"",getAllData().get(i).FM2);
        }
        return num+"";
    }
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<WortPrintData> {
        ...
        private TextView tv_PcsSplit;
        private TextView tv_M2;

        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_split_list);
            tv_Lenght =   $(R.id.tv_lenght);
            tv_Pcs =   $(R.id.tv_pcs);
            tv_PcsSplit =   $(R.id.tv_pcs_split);
            tv_M2 =   $(R.id.tv_m2);
        ...
        public void setData(WortPrintData data) {
            super.setData(data);
            tv_Lenght.setText(data.FLenght+"");
            tv_Pcs.setText(data.FQty);
            tv_PcsSplit.setText(MathUtil.toInt(data.FQtySplit)+"");
            tv_M2.setText(data.FM2);
        }
    }
