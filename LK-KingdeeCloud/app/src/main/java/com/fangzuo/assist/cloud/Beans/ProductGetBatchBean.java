...
public class ProductGetBatchBean {
    ...
    private List<ProductGetBean.ModelBean> Model;
    ...
    public List<ProductGetBean.ModelBean> getModel() {
        return Model;
    }

    public void setModel(List<ProductGetBean.ModelBean> Model) {
        this.Model = Model;
    }
