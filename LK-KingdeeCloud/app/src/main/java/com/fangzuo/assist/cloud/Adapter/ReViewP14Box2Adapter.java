...
public class ReViewP14Box2Adapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    List<ReBoxBean> detail;
    private ViewHolder viewHolder;
    InnerClickListener mListener;
    List<Boolean> isCheck;

    public ReViewP14Box2Adapter(Context context, List<ReBoxBean> detail, List<Boolean> isCheck) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_review_list_p1_4box2, null);
...
//        viewHolder.productname.setText("物料名称:" + detail.get(i).FProductName);
        ...
        viewHolder.tvBoxcode.setText("箱码"+detail.get(i).FBoxCode);
...
//        viewHolder.tvM2.setText("M2:" + detail.get(i).FCfM2Sum);
        viewHolder.tvLenght.setText("PCS:" + detail.get(i).FPCS);
//        viewHolder.tvThick.setText("厚:" + detail.get(i).FCfThick+"  MM");
        viewHolder.tvWide.setText("M3:" + detail.get(i).FM3);
        viewHolder.tvThick.setText("宽度:" + detail.get(i).FWide);
