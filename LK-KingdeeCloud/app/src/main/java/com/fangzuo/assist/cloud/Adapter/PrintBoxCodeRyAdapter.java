...
public class PrintBoxCodeRyAdapter extends RecyclerArrayAdapter<WortPrintData> {
    public PrintBoxCodeRyAdapter(Context context) {
        super(context);
    }
    //
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<WortPrintData> {
        ...
        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_print_boxcode);
        ...
        public void setData(WortPrintData data) {
            ...
            if (split.length == 3) {
                tvLenght.setText("总长:"+split[0]+"   MM");
                tvWide.setText("宽:"+split[1]+"   MM");
