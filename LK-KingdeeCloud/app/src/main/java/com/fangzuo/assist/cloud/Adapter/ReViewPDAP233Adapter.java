...
//                viewHolder.date.setText("物料名:" + detail.get(i).FProductName);
        ...
        viewHolder.tvNum.setText("码单数量:" + mdNum);
        viewHolder.tvNum2.setText("实检数量:" + qty);
        viewHolder.tvNum3.setText("数量差异:" + (MathUtil.toD(qty) - MathUtil.toD(mdNum)));
        viewHolder.tvNum4.setText("差异比重:" + ((int) (MathUtil.toD(detail.get(i).FRealQty)/ MathUtil.toD(detail.get(i).FQuantity) * 100))+" %");
