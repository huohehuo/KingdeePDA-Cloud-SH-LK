...
public class SplitBoxP1Adapter extends RecyclerArrayAdapter<PrintDataBean> {
    public SplitBoxP1Adapter(Context context) {
        super(context);
    }
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<PrintDataBean> {
        ...
        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_split_p1_list);
        ...
        public void setData(PrintDataBean data) {
            ...
            tv_model1.setText(data.FQty+"/"+data.FVol);
            tv_model2.setText(data.FQtySplit);
            tv_model3.setText(data.FVolSplit);
        }
    }
