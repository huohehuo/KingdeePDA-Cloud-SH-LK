...
import com.fangzuo.assist.cloud.databinding.ActivityProductCheck4P24WortBinding;
...
public class ProductCheck4P24WortActivity extends BaseActivity {
    ActivityProductCheck4P24WortBinding binding;
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_product_check4_p24_wort);
...
//        });
        ...
        binding.btnCheck.setOnClickListener(new NoDoubleClickListener() {
            ...
            protected void onNoDoubleClick(View view) {
                if (null==ht){
                    Toast.showText(mContext,"物料信息不完整，请重试");
                }else{
                    EventBusUtil.sendEvent(new ClassEvent(EventBusInfoCode.Product_4Wort,ht.FNumber));
                    finish();
                }
...
//                FIsPurchase="1";
    ...
    public static void start(Context context, int activity, String search, String org){
        Intent intent = new Intent(context,ProductCheck4P24WortActivity.class);
