...
public class FragmentP1PdCgrk2ProductionGetDetail extends BaseFragment {
...
//                btnBackorder.setClickable(true);
                    ...
                    delete.setNegativeButton("反馈信息", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DataService.pushBackJson(mContext, FragmentP1PdCgrk2ProductionGetDetail.this.getClass().getSimpleName(), Hawk.get(Config.Company,""));
                        }
                    });
                    delete.create().show();
                }
...
//                }
    ...
    public FragmentP1PdCgrk2ProductionGetDetail() {
