...
public class PrintBoxCode4P1RyAdapter extends RecyclerArrayAdapter<PrintDataBean> {
    public PrintBoxCode4P1RyAdapter(Context context) {
        super(context);
    }
    //
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<PrintDataBean> {
        ...
        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_print_boxcode4p1);
        ...
        public void setData(PrintDataBean data) {
            ...
            tvPihao.setText("批号:" + data.FBatch);
...
//            if (split.length == 3) {
                tvLenght.setText("总数量:"+data.FQtyAll);
                tvWide.setText("总体积:"+data.FVolAll);
