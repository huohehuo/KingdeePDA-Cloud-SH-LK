...
public class WideAdapter extends RecyclerArrayAdapter<CommonBean> {
    public WideAdapter(Context context) {
        super(context);
    }
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<CommonBean> {

        private TextView tv_Wide;

        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_wide_list);
            tv_Wide =   $(R.id.tv_wide);

        }

        @Override
        public void setData(CommonBean data) {
            super.setData(data);
            tv_Wide.setText(data.getFStandby1());
        }
    }
