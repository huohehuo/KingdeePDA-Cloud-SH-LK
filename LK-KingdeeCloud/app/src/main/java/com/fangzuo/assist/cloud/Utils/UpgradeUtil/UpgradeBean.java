package com.fangzuo.assist.cloud.Utils.UpgradeUtil;
...
public class UpgradeBean {
    ...
    public String UpgradeLog2;//终止日期格式： 20120101
    public String UpgradeLog3;//终止日期格式： 20120101
    public String UpgradeTime;//终止日期格式： 20120101
    public String UpgradeUrl;//终止日期格式： 20120101
    public String UpgradeUrl2;//终止日期格式： 20120101
    public String UpgradeUrl3;//终止日期格式： 20120101
